...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    public static void main(String[] a)
    {
        ...
        Turtle somchai = new Turtle();
        somchai.penColor("blue");
        somchai.width(8);
        somchai.speed(50);
        somchai.up();
        somchai.forward(320);
        ...
        Turtle minjeong = new Turtle();
        minjeong.penColor("green");
        minjeong.width(8);
        minjeong.speed(50);
        minjeong.up();
        minjeong.forward(620);
        minjeong.left(90);
        minjeong.forward(100);
        minjeong.down();
        minjeong.right(90);
        minjeong.forward(65);
        minjeong.right(180);
        ...
        Turtle maria = new Turtle();
        maria.penColor("green");
        maria.width(8);
        maria.speed(50);
        maria.up();
        maria.forward(1000);
        ...
        Turtle pirada = new Turtle();
        pirada.penColor("yellow");
        pirada.width(8);
        pirada.speed(50);
        pirada.up();
        pirada.forward(1300);
        ...
        Turtle mizuka = new Turtle();
        mizuka.penColor("orange");
        mizuka.width(8);
        mizuka.speed(50);
        mizuka.up();
        mizuka.forward(1400);
        ...
        Turtle navadon = new Turtle();
        navadon.penColor("black");
        navadon.width(15);
        navadon.speed(1);
        navadon.up();
        navadon.left(180);
